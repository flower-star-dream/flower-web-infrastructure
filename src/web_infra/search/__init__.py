...
@Description: 全文搜索引擎 SPI 与实现聚合导出（搜索引擎接入计划 v0.2.0 §3）：统一抽象接口、
              ...
              向量检索经 web_infra.ai.retrieval.elasticsearch_vector_store 接入
...
from web_infra.search.search_config import ElasticsearchSearchConfig, SearchConfig
...
from web_infra.search.search_engine_registry import SearchEngineFactory, SearchEngineRegistry
from web_infra.search.search_error_code import SearchErrorCode, SearchErrorCodeEnum
from web_infra.search.search_hit import SearchHit
from web_infra.search.search_query import SearchQuery
