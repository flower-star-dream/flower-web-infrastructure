...
"""
from web_infra.capabilities.http.feign_client import FeignClient, default_service_fallback
from web_infra.capabilities.http.feign_client_factory import FeignClientConfig, build_feign_client
