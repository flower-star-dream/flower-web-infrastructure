...
from web_infra.capabilities.payment.payment_channel_template import PaymentChannelTemplate, PaymentFlowContext
...
class PaymentChannelContract:
    ...
    async def _case_closed_callback(self) -> None:
        ...
        from web_infra.capabilities.payment import PaymentErrorCode, PaymentStateMachine
    ...
    async def _case_amount_mismatch(self) -> None:
        ...
        try:
            ...
            from web_infra.capabilities.payment import PaymentErrorCode
