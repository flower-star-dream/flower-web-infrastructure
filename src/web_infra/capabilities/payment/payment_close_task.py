...
from web_infra.infra.monitoring.payment_metrics import record_close
from web_infra.capabilities.payment.payment_channel_template import PaymentChannelTemplate
from web_infra.capabilities.payment.payment_order_store_interface import PaymentOrderStoreInterface
from web_infra.capabilities.payment.payment_status import PaymentStatus

logger = logging.getLogger("web_infra.capabilities.payment.close_task")
