...
from web_infra.infra.monitoring.payment_metrics import record_callback, record_prepay, record_refund
...
logger = logging.getLogger("web_infra.capabilities.payment.channel")
...
class PaymentChannelTemplate(ABC):
    ...
    async def _audit(self, action: str, out_trade_no: str, amount: Decimal | None,
        ...
        if self._audit_store is None:
            return
        try:
            from web_infra.capabilities.payment.payment_audit_store import PaymentAuditRecord
