...
@Description: 定义常量分类前缀（PARAM_/AUTH_/INFRA_/BIZ_/SYS_）与通用常量，
              ...
              本模块仅重导出（兼容 from web_infra.constants import X 的既有引用），禁止再定义重复常量。
"""
...
from web_infra.constants.biz_constant import BizConstant

# ---------------------------------------------------------------------------
# 重导出（兼容既有 from web_infra.constants import X 引用；值以分类常量类为准）
# ---------------------------------------------------------------------------
