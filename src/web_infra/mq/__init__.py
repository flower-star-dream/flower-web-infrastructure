...
from web_infra.mq.mq_config import MqConfig
from web_infra.mq.mq_exceptions import RetryableError, NonRetryableError
from web_infra.mq.message import Message, MessageHandler, generate_message_id
from web_infra.mq.message_publisher_interface import MessagePublisherInterface
from web_infra.mq.message_consumer_interface import MessageConsumerInterface
...
from web_infra.mq.idempotent_consumer import IdempotentConsumer
from web_infra.mq.retryable_consumer import RetryableConsumer
from web_infra.mq.outbox import (
    OutboxStatus,
    OutboxRecord,
...
# 消息常量（统一管理于 web_infra.constants，此处转发导出保持兼容）
